...
if(b<0||b>a.length)H.Vj(P.TE(b,0,a.length,null,null))
if(c<b||c>a.length)H.Vj(P.TE(c,b,a.length,null,null))
z=c-b
if(z===0)return
...
if(x==null)return
y=x[b]
return y==null?null:y.gcA()}else return this.Ei(b)},
Ei:function(a){var z,y,x
z=this.Cs
if(z==null)return
y=z[this.rk(a)]
...
lK:function(a){var z
this.K6("[")
if(J.q8(a)>0){if(0>=a.length)return H.e(a,0)
this.QD(a[0])
for(z=1;z<a.length;++z){this.K6(",")
...
y=J.q0(z)
H.VM(new W.xC(0,y.J6,y.fA,W.VF(A.qC()),y.el),[H.Kp(y,0)]).DN()
y=document.querySelector("#generateButton")
$.Tn=y
y=J.Vg(y)
H.VM(new W.xC(0,y.J6,y.fA,W.VF(A.OL()),y.el),[H.Kp(y,0)]).DN()
$.xR=document.querySelector("#badgeName")
y=W.Kn("api/piratenames.json",null,null).ml(A.Wz()).ml(new A.em(z))
x=new A.Lb()
w=H.VM(new P.vs(0,$.X3,null),[null])
v=w.t9
if(v!==C.NU)x=P.VH(x,v)
y.xf(new P.Fe(null,w,2,null,x))},"$0","KW",0,0,1],
...
if(a==null)return
z=$.xR
z.textContent=J.FN(a.zn)===!0?"":H.d(a.zn)+" the "+H.d(a.c8)
window.localStorage.setItem("pirateName",C.xr.KP(P.EF(["f",a.zn,"a",a.c8],null,null)))},
dK:function(){var z,y
...
QQ:{
"^":"a;zn,c8",
bu:function(a){return J.FN(this.zn)===!0?"":H.d(this.zn)+" the "+H.d(this.c8)},
iF:function(a,b){var z
if(b==null){z=$.Ck()
this.zn=J.UQ(z,$.VY().j1(J.q8(z)))}else this.zn=b
z=$.eg()
this.c8=J.UQ(z,$.VY().j1(J.q8(z)))},
...
init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"uJ",ret:P.a,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"WW",void:true,args:[W.ea]},{func:"uO",args:[P.qU]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Ns",void:true,args:[P.a],opt:[P.mE]},,{func:"Vx",void:true,args:[null],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"Za",args:[P.qU,null]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(A.KW(),b)},[])}else{(function(b){H.Rq(A.KW(),b)})([])}})
})()
